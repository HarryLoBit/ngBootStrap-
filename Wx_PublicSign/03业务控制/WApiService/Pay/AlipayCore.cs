    ...
    public class Core
    {
        ...
        public static Dictionary<string, string> FilterPara(SortedDictionary<string, string> dicArrayPre)
        {
            ...
            foreach (KeyValuePair<string, string> temp in dicArrayPre)
            {
                ...
                //if (temp.Key.ToLower() == "app_id" || temp.Key.ToLower() == "biz_content" || temp.Key.ToLower() == "charset" || temp.Key.ToLower() == "method" || temp.Key.ToLower() == "sign_type" || temp.Key.ToLower() == "timestamp" || temp.Key.ToLower() == "version" || temp.Key.ToLower()== "notify_url")
                //{
                //    dicArray.Add(temp.Key, temp.Value);
                //}
            }
